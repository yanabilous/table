          ...
          <button className="delete" onClick={() => handleDelete(item.id)}>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
              <g clipPath="url(#clip0_7010_30456)">
                <path d="M2.5 3.5H13.5V12C13.5 13.933 11.933 15.5 10 15.5H6C4.067 15.5 2.5 13.933 2.5 12V3.5Z"
                      stroke="#212121" strokeLinecap="round"/>
                <path d="M10 3.5V2.5C10 1.39543 9.10457 0.5 8 0.5V0.5C6.89543 0.5 6 1.39543 6 2.5V3.5"
                      stroke="#212121"/>
